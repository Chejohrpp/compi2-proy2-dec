...
name_report = 'Muertes segun regiones de un pais'

def analizar(filepath,param):
    ### Asignacion de celdas  ###############################################
    x_celda = param['tiempo']
    y_celda = param['fallecidos']
    celda_pais = param['celda_pais']
    celda_departamento = param['celda_region']
    nombre_pais = param['nombre_pais']
    nombre_departamento = param['nombre_region']
    ### Lista de variables  ###############################################
    lista_urls_imgs = []
    lista_urls_static = []
    datos_calculados = []
    ...
    if celda_pais != "" and nombre_pais != "":
        ...
        if celda_departamento != "" and nombre_departamento != "":
            ...
            datos_calculados.append("Region Utilizado : " + str(nombre_departamento))
