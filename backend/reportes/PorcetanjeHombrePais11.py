...
def analizar(filepath,param):
    ...
    plt.clf()
    #### enviar los datos #######################################################################
    return fr.addData(datos_calculados,lista_urls_imgs,lista_urls_static,datos_estaticos,'Se muestra el grafico de barras los porcentajes de infectados de hombres que sucede, ademas se dieron los datos para que puedan realizar una construccion de una grafica de prediccion de grado {}'.format(grado),name)
